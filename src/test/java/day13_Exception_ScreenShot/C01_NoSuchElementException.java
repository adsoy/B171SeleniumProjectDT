...
public class C01_NoSuchElementException  extends TestBase {
    ...
    public void test01() {
       /*
        ...
        3-Bir tıklama işleminden sonra yeni bir pencere açıldıysa driver'i o pencereye geçirmezsek bu hatayı
        alırız. Dolayısıyla pencere geçiş yapmamız gerekir
        4-Locate etmek istediğimiz webelement sayfanın altında ise bazen bazı sayfalar scroll yapmadan
        bu webelementi göremez. Dolayısıyla driver'a elementi göstermemiz gerekir.
 */
        driver.get("https://techproeducation.com");

        WebElement aramaKutusu = driver.findElement(By.xpath("fsdkfjskldg"));
