...
public class C04_WindowHandles extends TestBase {
    ...
    public void test02() {
       ...
       List<String> pencereler =new ArrayList<>(driver.getWindowHandles());
        ...
        //  ikinci sayfa Title'ının "New Window" olduğunu test edin.
        driver.switchTo().window(pencereler.get(1));// ikinci sayfa
        Assert.assertEquals("New Window",driver.getTitle());


        //  ilk sayfaya dönün ve Title'ının "The Internet" olduğunu test edin.
        driver.switchTo().window(pencereler.get(0));//ana sayfa
        Assert.assertEquals("The Internet",driver.getTitle());
        bekle(2);
    ...
    public void test03() {
        ...
        //  ikinci sayfa Title'ının "New Window" olduğunu test edin.
        driver.switchTo().window(driver.getWindowHandles().toArray()[1].toString());// ikinci sayfa
        Assert.assertEquals("New Window",driver.getTitle());


        //  ilk sayfaya dönün ve Title'ının "The Internet" olduğunu test edin.
        driver.switchTo().window(driver.getWindowHandles().toArray()[0].toString());//ana sayfa
        Assert.assertEquals("The Internet",driver.getTitle());
        bekle(2);
